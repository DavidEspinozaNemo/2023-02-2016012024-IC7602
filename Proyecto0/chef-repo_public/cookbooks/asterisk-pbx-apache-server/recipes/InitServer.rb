execute 'asterisk' do
    command 'sudo chown -R asterisk.asterisk /etc/asterisk'
    command 'sudo chown -R asterisk.asterisk /var/{lib,log,spool}/asterisk'
    command 'sudo chown -R asterisk.asterisk /usr/lib/asterisk'

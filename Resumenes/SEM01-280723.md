...
Palabras clave: ~FreePBX, Asterisk, Terraform, Oracle Academy, GCD, AWS, Chef, Puppet, Ansible, Virtual Box, Subred, Server, Responsability Matrix AWS, Hypervisor, PAAS, CIDR, VPC, Availability Zones, Route Table, Peering, Internet Gateway, NAT Gateway, Security Gruop, Firewall, TCP, UDP, NACL, IaC, Cloud Provider~
